...
.then(firmaliste => {
  ...
  // Sort the firmaliste array in ascending order based on floor
  firmaliste.sort((a, b) => a.floor - b.floor);
  
  // Reverse the sorted array
  firmaliste.reverse();

  // Iterate through the sorted and reversed firmaliste array
  for (let i = 0; i < firmaliste.length; i++) {
    ...
    floorNumber.style.marginTop = "11px";
    floorNumber.style.paddingLeft = "150px";
    floorNumber.style.fontSize = "30px";
